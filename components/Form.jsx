...
const Form = ({ type, post, setPost, submitting, handleSubmit }) => {
  return (
    <section className='w-full mt-[-1.5rem] max-w-full flex-start flex-col'>
      ...
      >
        ...
        <div className='flex-end mx-3 mb-5 gap-4'>
            ...
            <button type='submit' className='px-5 pb-[0.355rem] pt-[0.280rem] text-sm bg-primary-orange rounded-full text-white'
